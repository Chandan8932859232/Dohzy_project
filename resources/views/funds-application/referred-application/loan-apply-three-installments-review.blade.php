                      ...
                      <div class="col-md-12 mt-5 installment_payback_date" id="first_installment_payback_date">
                        ...
                        <div class="col-md-12 mt-5 installment_payback_date" id="first_installment_payback_date">
                            ...
                            <div class="input-group">
                                ...
                                <div class="col-md-12 mt-5 installment_payback_date" id="third_installment_payback_date">
                                    <label class="form_text">{{__('third installment payback amount')}} </label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">$CAD</span>
                                        </div>
                                        <input type="text"  name="thirdInstallmentAmount"
                                               value="{{session('amountPerInstallment')}}"
                                               class="form-control {{ $errors->has('thirdInstallmentAmount') ? ' is-invalid' : '' }}" readonly/>

                                        @if ($errors->has('thirdInstallmentAmount'))
                                            <span class="invalid-feedback" role="alert">
                                          <strong>{{ $errors->first('thirdInstallmentAmount') }}</strong>
                                         </span>
                                        @endif
                                    </div>
                                </div>

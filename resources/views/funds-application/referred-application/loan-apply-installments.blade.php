                  ...
                  <div class="form-row">  
                      ...
                      <div class="col-md-6 mt-4 installment_payback_date" id="first_installment_payback_date">
                        ...
                        <div class="input-group">
                            ...
                            <div class="col-md-6 mt-4 installment_payback_date" id="third_installment_payback_date">
                                <label class="form_text">Third installment amount</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">$CAD</span>
                                    </div>
                            ...
                            <div class="col-md-6 mt-4 installment_payback_date" id="fourth_installment_payback_date">
                                <label class="form_text">Fourth installment amount</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">$CAD</span>
                                    </div>

           ...
           <h4 class="text-center mt-3  mb-4 form_title">{{__('real estate assist')}} : {{__('upload prove')}}</h4><hr>
            ...
            <div class="card mt-5">
                ...
                <div class="card-header"> <h4 style="color:#251F4F; font-size:17px; font-weight: 500;">
                    <i class="fas fa-arrow-circle-right site_points"></i> {{__('please upload a document that proves you own real estate')}}
                    </h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <ul>
                        <li> {{__('notarized warranty deed')}}</li>
                        <li> {{__('purchase document')}}</li>
                        <li> {{__('mortgage statement')}}</li>
                        <li> {{__('property tax bill')}}</li>
                    </ul>
                </div>
            </div>
            </div>

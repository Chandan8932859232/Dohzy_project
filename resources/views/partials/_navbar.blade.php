                ...
                @if(!Auth::check()) <!-- if not logged in-->
                  ...
                  <li class="nav-item">
                   ...
                   <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">{{__('services')}}</a>
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="{{route('static-pages.personal-loans')}}">{{__('personal loans')}}</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="{{route('static-pages.business-loans')}}">{{__('business loans')}}</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="{{route('static-pages.savings')}}">{{__('savings')}}</a>
             ...
             @if(Auth::check()) {{--if user is logged in --}}
               ...
               @endif
                ...
                --}}
                 ...
                 <a class="nav-link" href="{{ route('profile.show', ['user_id'=> $user->getUserId()]) }}">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('request.center') }}"> <i class="fa fa-briefcase icon_color"></i> {{__('request center')}}</a>
                   </li><div class="dropdown-divider"></div>

                 <li class="nav-item">
                    <a class="nav-link" href="{{ route('payment.center') }}"> <i class="fas regular fa-credit-card icon_color"></i> {{__('payment center')}}</a>
                 </li><div class="dropdown-divider"></div>
              ...
              @endif
                 ...
                 <li class="nav-item dropdown my-2">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> {{__('services')}}</a>
                    <div class="dropdown-menu">
                      <a class="dropdown-item  my-2" href="{{route('static-pages.personal-loans')}}">{{__('personal loans')}}</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item  my-2" href="{{route('static-pages.business-loans')}}">{{__('business loans')}}</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item  my-2" href="#">{{__('savings')}}</a>
                 ...
                 <li class="nav-item my-2">
                     <a class="nav-link" href="{{ route('user.login') }}">{{ __('log in') }} </a>
                 </li><div class="dropdown-divider"></div>
                    ...
                    @guest
                        ...
                        <li class="nav-item pr-3">
                            <button class="login_button" type="submit" >
                              <a class="nav-link" style="color:#000000;" href="{{ route('user.login') }}">{{ __('log in') }} </a>
                            </button>
                        </li>
                        @if (Route::has('user.register'))
                            <li class="nav-item">
                                <button class="register_button" type="submit" >
                                    <a class="nav-link" style="color:#000000;" href="{{ route('user.register')  }}"> {{ __('join today') }}</a>
                                </button>
                            </li>
                </form>
                @endif

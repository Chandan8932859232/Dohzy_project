...
class BusinessAccountRequestAdminNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line('A user with the account id of '.$userAccountId.' has requested for a business account')
